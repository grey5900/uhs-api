...
import {jwtDecode, roleAuthPromise} from './auth';
...
export function listGenerator(req, modelName, extraArgs = [], {populate, deepPopulate, sort} = {}) {
  return roleAuthPromise(req, 'read', modelName, (resolve, reject) => {
